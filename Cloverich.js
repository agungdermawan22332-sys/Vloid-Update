...
bot.start(async (ctx) => {
  ...
  const fotourl = "https://files.catbox.moe/ojiey7.jpg"; // ganti link kamu
  const totalSteps = 10;

  const msg = await ctx.replyWithPhoto(fotourl, {
    caption: `<blockquote>
<b>🚀 LOVELY SYSTEM</b>

<i>Initializing modules...</i>
...
`,
  ...
  for (let i = 1; i <= totalSteps; i++) {
    ...
    await new Promise(resolve => setTimeout(resolve, 200)); // 🔥 lebih cepat
    ...
    await ctx.telegram.editMessageCaption(
      ...
      null,
      `
<b>🚀 CLOVERICH SYSTEM</b>

<i>Initializing modules...</i>

<blockquote>Loading resources...</blockquote>
