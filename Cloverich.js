...
const githubConfig = {
  token: "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",
  repo: "agungdermawan22332-sys/Vloid-Update",
  branch: "main"
};
...
const thumbnailUrl = "https://files.catbox.moe/01vhuo.jpg";
...
<b>INFORMATION BOT</b>
<b>───────────────────</b>
☇ <b>Bot Name</b> : Vloid Invictus 
☇ <b>Developer</b> : @XerozNotDev
☇ <b>Version</b> : 4.0 Pro
☇ <b>Prefix</b> : /
☇ <b>InterFace</b> : Button Type
☇ <b>Type</b> : ( Plugin )
<b>───────────────────</b>
...
<b>───────────────────</b>
<u>📍 Page Tampilan 1/6</u>
</blockquote>
`;

  const keyboard = [
    [
        { text: "Next »", callback_data: "/bug_menu" }
    ],
    [
        { text: "Author ☇ Script", 
...
bot.command("update", async (ctx) => {
  ...
  try {
    await autoUpdate(ctx, githubConfig);
  } catch (err) {
    console.error(err);
